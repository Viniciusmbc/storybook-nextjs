...
const SunIcon = () => <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.81724 0.899414C3.1055 0.899414 0.899414 3.10594 0.899414 5.81768C0.899414 8.52941 3.1055 10.7359 5.81724 10.7359C8.52854 10.7359 10.7351 8.52985 10.7351 5.81768C10.7351 3.1055 8.52854 0.899414 5.81724 0.899414Z" fill="#858BB2" />
</svg>



export const DarkModeToggle: React.FC = () => {
    // State to manage the theme (true for dark mode, false for light mode)
    const [isDarkMode, setIsDarkMode] = useState<boolean>(() => {
        const savedTheme = localStorage.getItem('theme');
        return savedTheme === 'dark' ? true : false;
    });

    // Effect to apply the theme to the body class and persist in localStorage
    useEffect(() => {
        if (isDarkMode) {
